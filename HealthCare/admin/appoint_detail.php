...
$select = "select app_no,fname,lname,phone,doc_name,reason,app_date,app_time from appointment a,users u,doctors d where u.u_id=a.u_id and a.doc_id=d.doc_id order by app_no";

$data = mysqli_query($conn, $select); {
    include("../include/dbconnect.php");
    error_reporting(0);
    $id = $_GET['id'];
    $delete = mysqli_query($conn, "DELETE FROM appointment where app_no='$id'");
}
...
<body>
    ...
    <div class="row">
                ...
                <div class="position-sticky">
                    <div>
                        ...
                        <a href="../admin/appoint_detail.php" style="text-decoration: none;">
                            <h6 style="color: blueviolet;">Appointments</h6>
                        </a>
                        <hr>
                    </div>
                </div>
        ...
        <div class="col-md-10" data-aos="fade-up" data-aos-duration="2000" style="overflow: auto;">
            <br>
            <h2 class="text-center view text-primary">APPOINTMENTS</h2>
            <hr>
            <table class=" mt-4">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($data)) {
                        echo "<tr class='hov'>
                            ...
                            <td>" . $row['app_time'] . "</td>
                            <td>
                            <a href='appoint_detail.php?id=" . $row['app_no'] . "' class='btn btn-danger'>DELETE</a>
                            </td>
                    </tr>";
                    }
